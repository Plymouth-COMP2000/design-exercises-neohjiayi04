...
/**
 * ApiHelper - Handles API calls for user management
 * Student ID: BSSE2506008
 * Based on your exact API pattern!
 */
public class ApiHelper {
    ...
    public static String createUser(String username, String password, String firstname,
        ...
        try {
            // API endpoint: /create_user/BSSE2506008
            ...
            jsonData.put("usertype", usertype); // "GUEST" or "STAFF"
    ...
    public static String getAllUsers() {
        try {
            // API endpoint: /read_all_users/BSSE2506008
    ...
    public static String updateUser(int userId, String username, String password, String firstname,
                                    String lastname, String email, String contact, String usertype) {
        try {
            // API endpoint: /update_user/BSSE2506008/{userId}
    ...
    public static String deleteUser(int userId) {
        try {
            // API endpoint: /delete_user/BSSE2506008/{userId}
