...
public class EditProfileActivity extends BaseActivity {
    ...
    private ImageView imageProfile, imageViewBack;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Bottom navigation active (highlight Profile tab)
    ...
    private void loadUserData() {
        try {
            ...
            if (!profileUriStr.isEmpty()) {
                imageProfile.setImageURI(Uri.parse(profileUriStr));
            }
    ...
    private void updateProfile() {
        ...
        try {
            ...
            String userId = json.getString("_id"); // use API _id
            String usertype = json.getString("usertype");

            btnSaveChanges.setEnabled(false);

            executor.execute(() -> {
                // Call API with _id instead of username/password
                String response = ApiHelper.updateUserById(
                        userId,
                        firstname,
                        lastname,
                        email,
                ...
                runOnUiThread(() -> {
                    ...
                    if (response.startsWith("Error")) {
                        Toast.makeText(EditProfileActivity.this, "Update failed: " + response, Toast.LENGTH_LONG).show();
                    } else {
                        try {
                            ...
                            Toast.makeText(EditProfileActivity.this, "Profile updated, but failed to save locally", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            });
